...
export default class TenantUpdateProvider {
  public async updateOne(criteria: TenantCriteria, updateData: UpdateTenantData, tx?: any) : Promise<Tenant> {
  ...
  public async updateMany(criteria: TenantCriteria, updateData: UpdateTenantData, tx?: any)  : Promise<Tenant[]> {
    const dbClient = tx ? tx : DbClient;
