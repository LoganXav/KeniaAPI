...
import { documentCreateSchema } from "../validators/DocumentCreateSchema";
import DocumentCreateService from "../services/DocumentCreate.service";

@autoInjectable()
export default class DocumentCreateController extends BaseController {
  static controllerName: string;
  private documentCreateService: DocumentCreateService;

  constructor(documentCreateService: DocumentCreateService) {
    super();
  ...
  public initializeRoutes(router: IRouter): void {
    ...
    this.addRoute({
      ...
      handlers: [validateData(documentCreateSchema), this.create],
      produces: [
        {
