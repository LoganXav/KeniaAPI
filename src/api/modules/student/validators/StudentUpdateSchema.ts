...
export const studentUpdateSchema = z.object({
  ...
  // admissionNo: z.string({ invalid_type_error: "Admission number must be a string" }).min(1, "Admission number is required").max(20, "Admission number must be less than 20 characters"),
