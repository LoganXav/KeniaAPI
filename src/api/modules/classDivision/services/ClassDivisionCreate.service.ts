...
@autoInjectable()
export default class ClassDivisionCreateService extends BaseService<ClassDivisionCreateRequestType> {
  ...
  public async execute(trace: ServiceTrace, args: ClassDivisionCreateRequestType): Promise<IResult> {
    try {
      this.initializeServiceTrace(trace, args);

      const classDivision = await this.classDivisionCreateProvider.create(args);
      trace.setSuccessful();
