...
import { ClassDivisionUpdateRequestType } from "../types/ClassDivisionTypes";
...
@autoInjectable()
export default class ClassDivisionUpdateService extends BaseService<ClassDivisionUpdateRequestType> {
  ...
  public async execute(trace: ServiceTrace, args: ClassDivisionUpdateRequestType): Promise<IResult> {
    try {
      this.initializeServiceTrace(trace, args);
      const classDivision = await this.classDivisionUpdateProvider.update(args);
      trace.setSuccessful();
