import { AppConstants } from "~/api/shared/setttings/AppSettings"
...
export class StringUtil {
  ...
  static decodeBase64(base64: string | Nulldefined): string | Nulldefined {
    ...
    return Buffer.from(base64, AppConstants.BASE64_ENCODING).toString(
      AppConstants.ASCII_ENCODING
    )
  }
  ...
  static encodeBase64(text: string | Nulldefined): string | Nulldefined {
    ...
    return Buffer.from(text, AppConstants.ASCII_ENCODING).toString(
