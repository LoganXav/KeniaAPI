...
-- CreateEnum
CREATE TYPE "PromotionStatus" AS ENUM ('Promoted', 'Withheld');
...
CREATE TABLE "ClassPromotion" (
    ...
    "fromClassDivisionId" INTEGER NOT NULL,
    "toClassDivisionId" INTEGER NOT NULL,
    "calendarId" INTEGER NOT NULL,
    "tenantId" INTEGER NOT NULL,
    "decisionAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "promotionStatus" "PromotionStatus" NOT NULL DEFAULT 'Promoted',
    "comments" TEXT,
