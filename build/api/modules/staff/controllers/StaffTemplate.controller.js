...
const StaffTemplateSchema_1 = require("../validators/StaffTemplateSchema");
const StaffTemplate_service_1 = __importDefault(require("../services/StaffTemplate.service"));
let StaffTemplateController = class StaffTemplateController extends Base_controller_1.default {
    constructor(staffTemplateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/staff/template",
            handlers: [(0, validateData_1.validateParams)(StaffTemplateSchema_1.staffTemplateParamsSchema), this.template],
            produces: [
                {
...
StaffTemplateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [StaffTemplate_service_1.default])
], StaffTemplateController);
exports.default = StaffTemplateController;
//# sourceMappingURL=StaffTemplate.controller.js.map