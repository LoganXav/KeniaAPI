...
const StaffCreateSchema_1 = require("../validators/StaffCreateSchema");
const StaffCreate_service_1 = __importDefault(require("../services/StaffCreate.service"));
let StaffCreateController = class StaffCreateController extends Base_controller_1.default {
    constructor(StaffCreateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/staff/create",
            handlers: [(0, validateData_1.validateData)(StaffCreateSchema_1.staffCreateRequestSchema), this.create],
            produces: [
                {
...
StaffCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [StaffCreate_service_1.default])
], StaffCreateController);
exports.default = StaffCreateController;
//# sourceMappingURL=StaffCreate.controller.js.map