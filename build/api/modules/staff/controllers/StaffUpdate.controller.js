...
const StaffUpdateSchema_1 = require("../validators/StaffUpdateSchema");
const StaffUpdate_service_1 = __importDefault(require("../services/StaffUpdate.service"));
let StaffUpdateController = class StaffUpdateController extends Base_controller_1.default {
    constructor(staffUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(StaffUpdateSchema_1.staffUpdateSchema), this.updateOne],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(StaffUpdateSchema_1.staffUpdateManySchema), this.updateMany],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
StaffUpdateController = __decorate([
    ...
    __metadata("design:paramtypes", [StaffUpdate_service_1.default])
], StaffUpdateController);
exports.default = StaffUpdateController;
//# sourceMappingURL=StaffUpdate.controller.js.map