...
const TimetableDelete_service_1 = __importDefault(require("../services/TimetableDelete.service"));
...
const TimetableDeleteSchema_1 = require("../validators/TimetableDeleteSchema");
...
let TimetableDeleteController = class TimetableDeleteController extends Base_controller_1.default {
    constructor(timetableDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(TimetableDeleteSchema_1.timetableDeleteSchema), this.delete],
            produces: [
                {
...
TimetableDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [TimetableDelete_service_1.default])
], TimetableDeleteController);
exports.default = TimetableDeleteController;
//# sourceMappingURL=TimetableDelete.controller.js.map