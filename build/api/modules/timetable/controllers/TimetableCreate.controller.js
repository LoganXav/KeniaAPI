...
const TimetableCreate_service_1 = __importDefault(require("../services/TimetableCreate.service"));
...
const TimetableCreateSchema_1 = require("../validators/TimetableCreateSchema");
...
let TimetableCreateController = class TimetableCreateController extends Base_controller_1.default {
    constructor(timetableCreateService) {
        super();
        this.createOrUpdate = async (req, res, next) => {
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(TimetableCreateSchema_1.timetableCreateOrUpdateSchema), this.createOrUpdate],
            produces: [
                {
...
TimetableCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [TimetableCreate_service_1.default])
], TimetableCreateController);
exports.default = TimetableCreateController;
//# sourceMappingURL=TimetableCreate.controller.js.map