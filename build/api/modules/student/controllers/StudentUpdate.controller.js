...
const StudentUpdate_service_1 = __importDefault(require("../services/StudentUpdate.service"));
...
const StudentUpdateSchema_1 = require("../validators/StudentUpdateSchema");
let StudentUpdateController = class StudentUpdateController extends Base_controller_1.default {
    constructor(studentUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(StudentUpdateSchema_1.studentUpdateSchema), this.updateOne],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(StudentUpdateSchema_1.studentUpdateManySchema), this.updateMany],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
StudentUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [StudentUpdate_service_1.default])
], StudentUpdateController);
exports.default = StudentUpdateController;
//# sourceMappingURL=StudentUpdate.controller.js.map