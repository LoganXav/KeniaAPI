...
const SubjectUpdate_service_1 = __importDefault(require("../services/SubjectUpdate.service"));
const SubjectUpdateSchema_1 = require("../validators/SubjectUpdateSchema");
...
let SubjectUpdateController = class SubjectUpdateController extends Base_controller_1.default {
    constructor(subjectUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(SubjectUpdateSchema_1.subjectUpdateSchema), this.update],
            produces: [
                {
...
SubjectUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [SubjectUpdate_service_1.default])
], SubjectUpdateController);
exports.default = SubjectUpdateController;
//# sourceMappingURL=SubjectUpdate.controller.js.map