...
const SubjectDelete_service_1 = __importDefault(require("../services/SubjectDelete.service"));
const SubjectDeleteSchema_1 = require("../validators/SubjectDeleteSchema");
...
let SubjectDeleteController = class SubjectDeleteController extends Base_controller_1.default {
    constructor(subjectDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/subject/delete",
            handlers: [(0, validateData_1.validateData)(SubjectDeleteSchema_1.SubjectDeleteSchema), this.delete],
            produces: [
                {
...
SubjectDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [SubjectDelete_service_1.default])
], SubjectDeleteController);
exports.default = SubjectDeleteController;
//# sourceMappingURL=SubjectDelete.controller.js.map