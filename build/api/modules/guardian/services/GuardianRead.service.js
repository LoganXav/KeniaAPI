...
let GuardianReadService = GuardianReadService_1 = class GuardianReadService extends Base_service_1.BaseService {
    constructor(guardianReadProvider) {
        super(GuardianReadService_1.serviceName);
    ...
    async execute(trace, args) {
        try {
            ...
            trace.setSuccessful();
            this.result.setData(SystemMessages_1.SUCCESS, HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS, (0, SystemMessagesFunction_1.RESOURCE_FETCHED_SUCCESSFULLY)(SystemMessages_1.GUARDIAN_RESOURCE), guardians);
            return this.result;
        }
        catch (error) {
    ...
    async readOne(trace, args) {
        try {
            ...
            trace.setSuccessful();
            this.result.setData(SystemMessages_1.SUCCESS, HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS, (0, SystemMessagesFunction_1.RESOURCE_FETCHED_SUCCESSFULLY)(SystemMessages_1.GUARDIAN_RESOURCE), guardian);
            return this.result;
        }
        catch (error) {
            this.loggingProvider.error(error);
...
GuardianReadService.serviceName = "GuardianReadService";
GuardianReadService = GuardianReadService_1 = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [GuardianRead_provider_1.default])
], GuardianReadService);
exports.default = GuardianReadService;
//# sourceMappingURL=GuardianRead.service.js.map