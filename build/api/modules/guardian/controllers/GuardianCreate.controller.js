...
const GuardianCreateSchema_1 = require("../validators/GuardianCreateSchema");
const GuardianCreate_service_1 = __importDefault(require("../services/GuardianCreate.service"));
let GuardianCreateController = class GuardianCreateController extends Base_controller_1.default {
    constructor(guardianCreateService) {
        super();
        this.create = async (req, res, next) => {
            return this.handleResultData(res, next, this.guardianCreateService.execute(res.trace, req), {
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(GuardianCreateSchema_1.guardianCreateSchema), this.create],
            produces: [
                {
...
GuardianCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [GuardianCreate_service_1.default])
], GuardianCreateController);
exports.default = GuardianCreateController;
//# sourceMappingURL=GuardianCreate.controller.js.map