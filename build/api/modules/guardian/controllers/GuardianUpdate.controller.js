...
const GuardianUpdateSchema_1 = require("../validators/GuardianUpdateSchema");
const GuardianUpdate_service_1 = __importDefault(require("../services/GuardianUpdate.service"));
let GuardianUpdateController = class GuardianUpdateController extends Base_controller_1.default {
    constructor(guardianUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(GuardianUpdateSchema_1.guardianUpdateSchema), this.update],
            produces: [
                {
...
GuardianUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [GuardianUpdate_service_1.default])
], GuardianUpdateController);
exports.default = GuardianUpdateController;
//# sourceMappingURL=GuardianUpdate.controller.js.map