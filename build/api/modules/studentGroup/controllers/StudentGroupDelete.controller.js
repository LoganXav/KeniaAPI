...
const StudentGroupDeleteSchema_1 = require("../validators/StudentGroupDeleteSchema");
const StudentGroupDelete_service_1 = __importDefault(require("../services/StudentGroupDelete.service"));
let StudentGroupDeleteController = class StudentGroupDeleteController extends Base_controller_1.default {
    constructor(studentGroupDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(StudentGroupDeleteSchema_1.studentGroupDeleteSchema), this.delete],
            produces: [
                {
...
StudentGroupDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [StudentGroupDelete_service_1.default])
], StudentGroupDeleteController);
exports.default = StudentGroupDeleteController;
//# sourceMappingURL=StudentGroupDelete.controller.js.map