...
const MedicalHistoryCreateSchema_1 = require("../validators/MedicalHistoryCreateSchema");
const MedicalHistoryCreate_service_1 = __importDefault(require("../services/MedicalHistoryCreate.service"));
let MedicalHistoryCreateController = class MedicalHistoryCreateController extends Base_controller_1.default {
    constructor(medicalHistoryCreateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(MedicalHistoryCreateSchema_1.medicalHistoryCreateSchema), this.create],
            produces: [
                {
...
MedicalHistoryCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [MedicalHistoryCreate_service_1.default])
], MedicalHistoryCreateController);
exports.default = MedicalHistoryCreateController;
//# sourceMappingURL=MedicalHistoryCreate.controller.js.map