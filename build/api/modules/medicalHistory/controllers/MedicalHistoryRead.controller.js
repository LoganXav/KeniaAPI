...
const MedicalHistoryReadSchema_1 = require("../validators/MedicalHistoryReadSchema");
const MedicalHistoryRead_service_1 = __importDefault(require("../services/MedicalHistoryRead.service"));
let MedicalHistoryReadController = class MedicalHistoryReadController extends Base_controller_1.default {
    constructor(medicalHistoryReadService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(MedicalHistoryReadSchema_1.medicalHistoryReadSchema), this.read],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(MedicalHistoryReadSchema_1.medicalHistoryReadSchema), this.readOne],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
MedicalHistoryReadController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [MedicalHistoryRead_service_1.default])
], MedicalHistoryReadController);
exports.default = MedicalHistoryReadController;
//# sourceMappingURL=MedicalHistoryRead.controller.js.map