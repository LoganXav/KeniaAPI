...
const DocumentTypeDeleteSchema_1 = require("../validators/DocumentTypeDeleteSchema");
const DocumentTypeDelete_service_1 = __importDefault(require("../services/DocumentTypeDelete.service"));
let DocumentTypeDeleteController = class DocumentTypeDeleteController extends Base_controller_1.default {
    constructor(documentTypeDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DocumentTypeDeleteSchema_1.DocumentTypeDeleteSchema), this.delete],
            produces: [
                {
...
DocumentTypeDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DocumentTypeDelete_service_1.default])
], DocumentTypeDeleteController);
exports.default = DocumentTypeDeleteController;
//# sourceMappingURL=DocumentTypeDelete.controller.js.map