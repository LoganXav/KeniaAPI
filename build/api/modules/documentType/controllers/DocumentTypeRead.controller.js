...
const DocumentTypeReadSchema_1 = require("../validators/DocumentTypeReadSchema");
const DocumentTypeRead_service_1 = __importDefault(require("../services/DocumentTypeRead.service"));
let DocumentTypeReadController = class DocumentTypeReadController extends Base_controller_1.default {
    constructor(documentTypeReadService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DocumentTypeReadSchema_1.documentTypeReadSchema), this.read],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DocumentTypeReadSchema_1.documentTypeReadSchema), this.readOne],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
DocumentTypeReadController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DocumentTypeRead_service_1.default])
], DocumentTypeReadController);
exports.default = DocumentTypeReadController;
//# sourceMappingURL=DocumentTypeRead.controller.js.map