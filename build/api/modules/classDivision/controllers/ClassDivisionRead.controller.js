...
const ClassDivisionReadSchema_1 = require("../validators/ClassDivisionReadSchema");
const ClassDivisionRead_service_1 = __importDefault(require("../services/ClassDivisionRead.service"));
let ClassDivisionReadController = class ClassDivisionReadController extends Base_controller_1.default {
    constructor(classDivisionReadService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(ClassDivisionReadSchema_1.classDivisionReadSchema), this.read],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(ClassDivisionReadSchema_1.classDivisionReadSchema), this.readOne],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
ClassDivisionReadController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassDivisionRead_service_1.default])
], ClassDivisionReadController);
exports.default = ClassDivisionReadController;
//# sourceMappingURL=ClassDivisionRead.controller.js.map