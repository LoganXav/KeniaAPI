...
const ClassDivisionCreateSchema_1 = require("../validators/ClassDivisionCreateSchema");
const ClassDivisionCreate_service_1 = __importDefault(require("../services/ClassDivisionCreate.service"));
let ClassDivisionCreateController = class ClassDivisionCreateController extends Base_controller_1.default {
    constructor(classDivisionCreateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(ClassDivisionCreateSchema_1.classDivisionCreateSchema), this.create],
            produces: [
                {
...
ClassDivisionCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassDivisionCreate_service_1.default])
], ClassDivisionCreateController);
exports.default = ClassDivisionCreateController;
//# sourceMappingURL=ClassDivisionCreate.controller.js.map