...
const ClassDivisionUpdateSchema_1 = require("../validators/ClassDivisionUpdateSchema");
const ClassDivisionUpdate_service_1 = __importDefault(require("../services/ClassDivisionUpdate.service"));
let ClassDivisionUpdateController = class ClassDivisionUpdateController extends Base_controller_1.default {
    constructor(classDivisionUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(ClassDivisionUpdateSchema_1.classDivisionUpdateSchema), this.update],
            produces: [
                {
...
ClassDivisionUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassDivisionUpdate_service_1.default])
], ClassDivisionUpdateController);
exports.default = ClassDivisionUpdateController;
//# sourceMappingURL=ClassDivisionUpdate.controller.js.map