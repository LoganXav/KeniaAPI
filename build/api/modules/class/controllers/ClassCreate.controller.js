...
const ClassCreateSchema_1 = require("../validators/ClassCreateSchema");
const ClassCreate_service_1 = __importDefault(require("../services/ClassCreate.service"));
let ClassCreateController = class ClassCreateController extends Base_controller_1.default {
    constructor(classCreateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/class/create",
            handlers: [(0, validateData_1.validateData)(ClassCreateSchema_1.classCreateSchema), this.create],
            produces: [
                {
...
ClassCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassCreate_service_1.default])
], ClassCreateController);
exports.default = ClassCreateController;
//# sourceMappingURL=ClassCreate.controller.js.map