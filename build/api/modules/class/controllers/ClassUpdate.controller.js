...
const ClassUpdateSchema_1 = require("../validators/ClassUpdateSchema");
const ClassUpdate_service_1 = __importDefault(require("../services/ClassUpdate.service"));
let ClassUpdateController = class ClassUpdateController extends Base_controller_1.default {
    constructor(classUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(ClassUpdateSchema_1.classUpdateSchema), this.update],
            produces: [
                {
...
ClassUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassUpdate_service_1.default])
], ClassUpdateController);
exports.default = ClassUpdateController;
//# sourceMappingURL=ClassUpdate.controller.js.map