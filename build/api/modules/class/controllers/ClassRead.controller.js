...
const ClassRead_service_1 = __importDefault(require("../services/ClassRead.service"));
const ClassReadSchema_1 = require("../validators/ClassReadSchema");
const validateData_1 = require("../../../shared/helpers/middleware/validateData");
let ClassReadController = class ClassReadController extends Base_controller_1.default {
    constructor(classReadService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/class/list",
            handlers: [(0, validateData_1.validateData)(ClassReadSchema_1.classReadSchema), this.getAll],
            produces: [
                {
        ...
        this.addRoute({
            method: HttpMethod_enum_1.HttpMethodEnum.POST,
            path: "/class/info/:id",
            handlers: [(0, validateData_1.validateData)(ClassReadSchema_1.classReadSchema), this.getOne],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
ClassReadController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [ClassRead_service_1.default])
], ClassReadController);
exports.default = ClassReadController;
//# sourceMappingURL=ClassRead.controller.js.map