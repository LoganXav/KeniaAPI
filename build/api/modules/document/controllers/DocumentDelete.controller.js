...
const DocumentDeleteSchema_1 = require("../validators/DocumentDeleteSchema");
const DocumentDelete_service_1 = __importDefault(require("../services/DocumentDelete.service"));
let DocumentDeleteController = class DocumentDeleteController extends Base_controller_1.default {
    constructor(documentDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DocumentDeleteSchema_1.DocumentDeleteSchema), this.delete],
            produces: [
                {
...
DocumentDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DocumentDelete_service_1.default])
], DocumentDeleteController);
exports.default = DocumentDeleteController;
//# sourceMappingURL=DocumentDelete.controller.js.map