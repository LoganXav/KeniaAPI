...
const DocumentUpdateSchema_1 = require("../validators/DocumentUpdateSchema");
const DocumentUpdate_service_1 = __importDefault(require("../services/DocumentUpdate.service"));
let DocumentUpdateController = class DocumentUpdateController extends Base_controller_1.default {
    constructor(documentUpdateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DocumentUpdateSchema_1.documentUpdateSchema), this.update],
            produces: [
                {
...
DocumentUpdateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DocumentUpdate_service_1.default])
], DocumentUpdateController);
exports.default = DocumentUpdateController;
//# sourceMappingURL=DocumentUpdate.controller.js.map