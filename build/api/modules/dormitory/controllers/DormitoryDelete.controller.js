...
const DormitoryDeleteSchema_1 = require("../validators/DormitoryDeleteSchema");
const DormitoryDelete_service_1 = __importDefault(require("../services/DormitoryDelete.service"));
let DormitoryDeleteController = class DormitoryDeleteController extends Base_controller_1.default {
    constructor(dormitoryDeleteService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DormitoryDeleteSchema_1.dormitoryDeleteSchema), this.delete],
            produces: [
                {
...
DormitoryDeleteController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DormitoryDelete_service_1.default])
], DormitoryDeleteController);
exports.default = DormitoryDeleteController;
//# sourceMappingURL=DormitoryDelete.controller.js.map