...
const DormitoryReadSchema_1 = require("../validators/DormitoryReadSchema");
const DormitoryRead_service_1 = __importDefault(require("../services/DormitoryRead.service"));
let DormitoryReadController = class DormitoryReadController extends Base_controller_1.default {
    constructor(dormitoryReadService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            path: "/dormitory/list",
            handlers: [(0, validateData_1.validateData)(DormitoryReadSchema_1.dormitoryReadSchema), this.read],
            produces: [
                {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(DormitoryReadSchema_1.dormitoryReadSchema), this.readOne],
            produces: [
                {
                    applicationStatus: ApplicationStatus_enum_1.default.SUCCESS,
                    httpStatus: HttpStatusCode_enum_1.HttpStatusCodeEnum.SUCCESS,
...
DormitoryReadController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [DormitoryRead_service_1.default])
], DormitoryReadController);
exports.default = DormitoryReadController;
//# sourceMappingURL=DormitoryRead.controller.js.map