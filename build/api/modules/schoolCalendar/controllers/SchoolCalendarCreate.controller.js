...
const SchoolCalendarCreate_service_1 = __importDefault(require("../services/SchoolCalendarCreate.service"));
...
const SchoolCalendarCreateSchema_1 = require("../validators/SchoolCalendarCreateSchema");
let SchoolCalendarCreateController = class SchoolCalendarCreateController extends Base_controller_1.default {
    constructor(schoolCalendarCreateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateData)(SchoolCalendarCreateSchema_1.schoolCalendarCreateSchema), this.create],
            produces: [
                {
...
SchoolCalendarCreateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [SchoolCalendarCreate_service_1.default])
], SchoolCalendarCreateController);
exports.default = SchoolCalendarCreateController;
//# sourceMappingURL=SchoolCalendarCreate.controller.js.map