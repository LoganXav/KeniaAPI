...
const OnboardingTemplate_service_1 = __importDefault(require("../services/OnboardingTemplate.service"));
...
let OnboardingTemplateController = class OnboardingTemplateController extends Base_controller_1.default {
    constructor(onboardingTemplateService) {
        super();
    ...
    initializeRoutes(router) {
        ...
        this.addRoute({
            ...
            handlers: [(0, validateData_1.validateParams)(OnboardingSchema_1.onboardingTemplateParamsSchema), this.template],
            produces: [
                {
...
OnboardingTemplateController = __decorate([
    (0, tsyringe_1.autoInjectable)(),
    __metadata("design:paramtypes", [OnboardingTemplate_service_1.default])
], OnboardingTemplateController);
exports.default = OnboardingTemplateController;
//# sourceMappingURL=OnboardingTemplate.controller.js.map